...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_genre = Genre.objects.create(name='奇幻小說')
        test_language = Language.objects.create(name='中文')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_create_user_if_not_login(self):
    ...
    def test_create_user_if_no_permission(self):
        login = self.client.login(username='testuser1', password='12345')
        resp = self.client.get(reverse('author_create'))
        #Manually check redirect (Can't use assertRedirect, because the redirect URL is unpredictable)
